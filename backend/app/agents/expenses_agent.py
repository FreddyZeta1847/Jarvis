...
EXPENSES_SYSTEM_PROMPT = (
    ...
    "2. Valid categories are EXACTLY: shopping, transport, food, presents, car, medical, subscription. "
    "Use ONLY these categories, do not invent or use any others. "
    "Map user intent to the closest match (e.g. 'gas' or 'fuel' or 'parking' -> car, 'gift' -> presents, 'doctor' or 'pharmacy' -> medical, 'Netflix' or 'Spotify' -> subscription, 'groceries' or 'restaurant' -> food).\n"
