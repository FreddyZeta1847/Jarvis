...
function Navbar({ language, onLanguageChange, onOpenThemePicker }) {
    ...
    <nav className="navbar">
      ...
      <div className="navbar-controls">
        ...
        <div className="lang-selector" ref={langRef}>
          ...
          >
            <img className="lang-flag" src={currentLang.flag} alt="" />
        ...
        {/* Settings */}
        <div className="settings-selector" ref={settingsRef}>
          <button
